...
<body>
  ...
  <script>
    const fields = [
      ...
      ["optimizer_plan_enabled", "checkbox", "Optimizer plan"],
      ["optimizer_plan_interval_seconds", "number", "Optimizer plan interval seconds"],
      ["optimizer_target_daily_pnl", "number", "Optimizer target daily PnL"],
      ["optimizer_max_order_size_ceiling", "number", "Optimizer max order size ceiling"],
      ["optimizer_max_exposure_ceiling", "number", "Optimizer max exposure ceiling"],
    ...
    const fieldHints = {
      ...
      optimizer_plan_enabled: "Periodically tune paper settings from optimizer and PnL evidence.",
      optimizer_plan_interval_seconds: "Minimum seconds between automatic optimizer-plan setting changes.",
      optimizer_target_daily_pnl: "Daily paper PnL target used by the automatic optimizer plan.",
      optimizer_max_order_size_ceiling: "Hard ceiling for auto-increased order and max-order sizes.",
      optimizer_max_exposure_ceiling: "Hard ceiling for auto-increased total exposure.",
